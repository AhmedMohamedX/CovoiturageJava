 ...
 * @author Mortadhafff
 */
public class RechercheAnnoncesController implements Initializable {
...
//    FilteredList<Question> filtredQuestions = new FilteredList(question, predicate -> true);
    ...
    private void chargelistview() {  
            String vd = NavigatorData.getInstance().getVd();
            String va = NavigatorData.getInstance().getVa();
            
            LocalDate d = NavigatorData.getInstance().getD();
            
          
            if(q.recherche(vd,va,d).isEmpty()){
            ...
            //label datep
            Label datep = new Label("                                                                                                         pas de résultats");
        ...
        for (Annonce que : q.recherche(vd,va,d)) {
