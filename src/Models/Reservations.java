...
public class Reservations {
    ...
    public Reservations(int annonce, String chauffeur, String passager1, String passager2, String passager3, String passager4, Date DateReservation) {
    ...
    public Reservations(int annonce, String chauffeur, String passager1, String passager2, String passager3, String passager4, Date DateReservation, int nbplace) {
        this.annonce = annonce;
        this.chauffeur = chauffeur;
        this.passager1 = passager1;
        this.passager2 = passager2;
    ...
    public Reservations(int id, int annonce, String chauffeur, String passager1, String passager2, String passager3, String passager4, Date DateReservation, int nbplace) {
        this.id = id;
        this.annonce = annonce;
        this.chauffeur = chauffeur;
        this.passager1 = passager1;
